...
export const gameCatalog: GameDefinition[] = [
  ...
  },
  {
    slug: "vault-mines",
    title: "Найди шаву",
    subtitle: "Азартно Опасно Вкусно Пошло",
    description: "Открывай клетки на поле 5x5, собирай безопасную серию и выводи до попадания на повариху.",
    accent: "from-emerald-300 via-teal-500 to-cyan-500",
    eyebrow: "Мины",
    thumbnail: "Съешь как можно больше шаверм!",
    hero: "Съешь как можно больше шаверм и не попадись похотливой поварихе!",
    kind: "mines",
    config: {
      type: "mines",
      boardSize: 5,
